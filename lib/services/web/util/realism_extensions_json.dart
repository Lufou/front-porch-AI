...
FrontPorchExtensions frontPorchFromFields(
  ...
  return FrontPorchExtensions(
    ...
    needsBaselineBowels: asInt('needsBaselineBowels', b.needsBaselineBowels),
    ...
    needsDecayBowels: asInt('needsDecayBowels', b.needsDecayBowels),
...
Map<String, dynamic> frontPorchToJson(FrontPorchExtensions e) => {
  ...
  'needsBaselineBowels': e.needsBaselineBowels,
  ...
  'needsDecayBowels': e.needsDecayBowels,
